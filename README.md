# Diego Alejandro Molano Roa — Platanus Build Night — Bogotá @ Buk Project
...
- Diego Alejandro Molano Roa ([@dmolanor](https://github.com/dmolanor))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-co-dmolanor.git
